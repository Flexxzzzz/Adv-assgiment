...
This file explains the changes in the refactored solution below the protected legacy section of `Assignment_03.py`.
...
These prompts are short paraphrases of the requests I made while working on the assignment.
